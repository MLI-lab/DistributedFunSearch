...
class LLM_model:
    ...
    def __init__(self, samples_per_prompt: int, device="cuda", checkpoint="meta-llama/Meta-Llama-3.1-8B-Instruct") -> None:
        ...
        huggingface_token = "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"  # Replace with your Hugging Face token
