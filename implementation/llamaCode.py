...
class LLM_model:
    ...
    def __init__(self, samples_per_prompt: int, device="cuda", checkpoint="implementation/codellama/CodeLlama-13b-Python") -> None:
        ...
        try: 
            self.model = LlamaForCausalLM.from_pretrained(self.checkpoint, device_map="auto", torch_dtype=torch.float16)
