...
def load_checkpoint(checkpoint_file: str, database) -> None:
    ...
    database.total_prompts = checkpoint_data.get("total_prompts", 0)
    database.duplicate_prompts = checkpoint_data.get("duplicate_prompts", checkpoint_data.get("dublicate_prompts", 0))
...
def serialize_checkpoint(database) -> dict:
    ...
    checkpoint_data = {
        ...
        "last_reset_time": database._last_reset_time,
        "total_resets": database._total_resets,
        "total_prompts": database.total_prompts,
        "duplicate_prompts": database.duplicate_prompts,
        "perc_duplicate_prompts": (database.duplicate_prompts / database.total_prompts if database.total_prompts else 0),
