...
def test_funsearch():
    ...
    print("- Stage 1 asks to describe heuristic")
    print("- Stage 2 has {reflection} placeholder")
    print_prompt(refl)
    ...
    print("- 2 programs, stage 1 asks to compare")
    ...
    print("\n--- 8. Multi-turn system messages ---")
    # Multi-turn has separate system messages for stage 1 and stage 2.
    # Stage 1, plain text output (no tags).
    # Stage 2, code output with <code> tags.
    ...
    for variant in ["thought", "reflection"]:
        ...
        # Stage 1 should not have code tags, it is for reasoning.
        assert "<code>" not in stage1_msg, f"Stage 1 {variant} should not have <code>"
        # Stage 2 should have code tags, for code output.
        assert "<code>" in stage2_msg, f"Stage 2 {variant} should have <code>"
        print(f"- multi_turn/{variant}, stage 1 no tags, stage 2 has <code>")
