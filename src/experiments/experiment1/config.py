...
class PromptConfig:
    ...
    funsearch_problem_desc: str = "funsearch/problem_descriptions/instruction_basic.txt"
    funsearch_system_message: str | None = "funsearch/system_messages/basic.txt" #"funsearch/system_messages/basic.txt"
...
class TerminationConfig:
    ...
    iteration_limit: int = 500_000  # Used when termination_mode="iterations"
