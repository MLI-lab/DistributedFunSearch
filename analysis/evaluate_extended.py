...
Usage:
    python evaluate_extended.py <functions_json> [options]

Examples:
    python evaluate_extended.py ./successful_functions/successful_functions.json
    python evaluate_extended.py ./successful_functions/successful_functions.json --max-n 16
    python evaluate_extended.py ./successful_functions/successful_functions.json --workers 8

    # Resume from checkpoint after crash
    python evaluate_extended.py ./successful_functions/successful_functions.json --resume
"""
