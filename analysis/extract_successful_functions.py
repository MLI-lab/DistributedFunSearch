...
Usage:
    python extract_successful_functions.py <path1> [path2 ...] [options]

Examples:
    # Single checkpoint
    python extract_successful_functions.py /path/to/checkpoint.pkl

    # Multiple checkpoints
    python extract_successful_functions.py checkpoint1.pkl checkpoint2.pkl

    # Folder (scans all .pkl files)
    python extract_successful_functions.py /path/to/checkpoints/

    # Multiple folders
    python extract_successful_functions.py /exp1/checkpoints/ /exp2/checkpoints/

    # Mix of files and folders
    python extract_successful_functions.py /exp1/ /exp2/checkpoint.pkl --output ./results/

    # With custom target signature
    python extract_successful_functions.py /path/to/checkpoints/ \\
